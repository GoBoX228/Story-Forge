...
import { Item, ItemRarity, ItemType, StatModifier, StatKey } from '../types';
...
const ItemsEditor: React.FC<ItemsEditorProps> = ({ data, onUpdate, onCreateItem, onUpdateItem, onDeleteItem }) => {
  ...
  const filteredItems = data
    .filter(item => (activeFilter === 'ВСЕ' || item.rarity === activeFilter) && (item.name.toLowerCase().includes(searchQuery.toLowerCase())))
    .sort((a, b) => {
