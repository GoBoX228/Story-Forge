...
use App\Domain\Core\Policies\AssetCollectionPolicy;
use App\Domain\Core\Policies\AssetFolderPolicy;
use App\Domain\Core\Policies\CampaignPolicy;
use App\Domain\Core\Policies\CharacterPolicy;
use App\Domain\Core\Policies\CharacterGroupPolicy;
use App\Domain\Core\Policies\ChroniclePolicy;
...
use App\Domain\Core\Policies\ItemGroupPolicy;
...
use App\Domain\Core\Policies\ScenarioGroupPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(AssetFolder::class, AssetFolderPolicy::class);
        Gate::policy(Campaign::class, CampaignPolicy::class);
        Gate::policy(Scenario::class, ScenarioPolicy::class);
        Gate::policy(ScenarioGroup::class, ScenarioGroupPolicy::class);
        ...
        Gate::policy(Chronicle::class, ChroniclePolicy::class);
        ...
        Gate::policy(CharacterGroup::class, CharacterGroupPolicy::class);
        Gate::policy(Item::class, ItemPolicy::class);
        Gate::policy(ItemGroup::class, ItemGroupPolicy::class);
